...
Ext.define('Ext.ux.uploadPanel.UploadPanel',{
	...
	columns : [
			...
			var stml =
				'<div>'+
					'<div style="border:1px solid #008000;height:10px;width:115px;margin:2px 0px 1px 0px;float:left;">'+		
						'<div style="float:left;background:#5BB339;width:'+v+'%;height:8px;"><div></div></div>'+
					'</div>'+
		...
		}},
        {
            ...
            width:50,
            items: [{
                icon: g_GlobalInfo.webRoot+'frm/extjs4/plugin/images/delete.gif',
                tooltip: 'Remove',
	...
	post_params : {},
	upload_url : 'test.do',
	flash_url : g_GlobalInfo.webRoot+"frm/otherWidget/swfupload.swf",
	flash9_url : g_GlobalInfo.webRoot+"frm/otherWidget/swfupload_fp9.swf",
	...
	upload_success_handler : function(file, serverData, responseReceived){
		...
		rec.commit();
		//加入自定义上传成功后的处理逻辑
		me.successCallBack(file, serverData, responseReceived);
