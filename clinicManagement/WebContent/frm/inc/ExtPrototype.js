...
Object.extend(Object, {
    copyObject: function(obj){
        ...
        if (PiggyOrg.lang.isArray(obj)) {
            ...
            if (PiggyOrg.lang.isNumber(obj) || PiggyOrg.lang.isString(obj) || PiggyOrg.lang.isBoolean(obj) || PiggyOrg.lang.isDate(obj)) 
                destination = obj;
            else 
                destination = {};
...
Object.extend(Object, {
    keys: function(obj){
        if (typeof obj !== "object") {
            throw "The parameter 'obj' is not a Object.";
        }
        var results = [];
        for (var property in obj) {
...
Object.extend(Array.prototype, {
    removeItem: function(index, size){//原来叫remove，跟SmartClient有冲突，改名
    ...
    formatString: function(decimal, round){
        ...
        if (index > 0) {
            ...
            if (arr[1].length > decimal) {
                val = (decimal === 0) ? arr[0] : (arr[0] + "." + arr[1].substring(0, decimal));
            } else {
                val = (decimal === 0) ? arr[0] : (arr[0] + "." + arr[1] + zeroTmp.substring(0, decimal - arr[1].length));
            }
        } else {
            if (decimal !== 0) {
